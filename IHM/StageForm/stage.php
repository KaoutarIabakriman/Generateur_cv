            ...
            <div class="p-12">
                <div class="step" id="step-2">
                    ...
                    <div class="mt-6 flex justify-between">
                        <a href="../personal/users.php"    class="prev bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-3 rounded-lg focus:outline-none">Précédent</a>
                        <a href="../CompetLang/compet.php" class="next bg-cyan-500 text-white px-6 py-3 rounded-lg hover:bg-cyan-600 focus:outline-none">Suivant</a>
                    </div>
                </div>
            </div>
        </form>
