    ...
    <div class="p-12">
        <div class="grid md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="nom" value="<?php echo htmlspecialchars($user['nom']); ?>" class="w-full px-4 py-3 border-2 border-cyan-500 rounded-xl" readonly>
            </div>
            <div>
                <label class="block mb-3 text-sm font-medium text-cyan-700">Prénom</label>
                <input type="text" name="prenom" value="<?php echo htmlspecialchars($user['prenom']); ?>" class="w-full px-4 py-3 border-2 border-cyan-500 rounded-xl" readonly>
            </div>
        </div>
        <div class="grid md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo htmlspecialchars($user['email']); ?>" class="w-full px-4 py-3 border-2 border-cyan-500 rounded-xl" readonly>
            </div>
        </div>
